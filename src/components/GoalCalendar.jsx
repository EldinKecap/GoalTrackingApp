    ...
    <Box sx={classes.container}>
      ...
      <Box sx={classes.datesAndWeekdaysContainer}>
        ...
        {datesForTheWholeYear.map((date) => {
          ...
          const dateInISOStringForComparingWithCompletedGoalsDates =
            year + "-" + month + "-" + day;

          if (
            datesForCompletedGoals != undefined &&
            datesForCompletedGoals.includes(
              dateInISOStringForComparingWithCompletedGoalsDates
            )
          ) {
            return (
              <Paper
                key={dateInISOStringForComparingWithCompletedGoalsDates}
                sx={{ ...classes.day, backgroundColor: "lightgreen" }}
              ></Paper>
            );
          }
          return (
